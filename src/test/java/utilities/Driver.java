...
public class Driver {
    ...
    //WebDriver tipinde bir ThreadLocal object oluşturduk
    //Bu sayede paralel test yaparken her thread in kendi webDriver objectine sahip olmasını sağladık
    //böylece paralel olarak çalışan farklı threadler birbirlerinin webDriverlarını etkileyemezler
